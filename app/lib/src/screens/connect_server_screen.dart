                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      'Device credential or development token',
                                ...
                                validator: (value) =>
                                    value == null || value.trim().isEmpty
                                    ? 'Enter a credential generated by your server.'
                                    : null,
                              ),
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Distinct device credentials are available through the agent CLI. '
              'This app still keeps credentials only for the current session, '
              'and remote connections require HTTPS.',
